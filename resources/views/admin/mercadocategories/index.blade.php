...
@section('header')
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Categorías Mercados</li>
      </ol>
    </section>
@endsection
            ...
            <div class="box box-default">
                ...
                <div class="box-body">
                  <div class="row">
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{$category->name}}</td>
                            <td>
                              {!! Form::open(['route' => ['mercadocategories.destroy', $category->id], 'method' => 'DELETE']) !!}
                    ...
                    <div class="col-md-4">
                      <div class="well">
                        {!! Form::open(['route' => 'mercadocategories.store', 'method' => 'POST']) !!}
          <p>Nueva Categoria</p>
