...
@section('metas')
    <meta name="description" content="Puntos de Venta | Ecoalimentate">
    <title>Puntos de Venta | Ecoalimentate</title>
@endsection
...
@endsection
    ...
    <div id="cabecera">
        <div class="container">
            <h1 class="titles">Puntos de Venta</h1>
        </div>
    </div>
    ...
    <section id="mapax">
        <h1 class="text-center">Puntos de Venta</h1><br>
        <div id="map"></div>
...
@section('scripts')
    ...
    <script src="{{asset('js/puntosventa.js')}}"></script>
